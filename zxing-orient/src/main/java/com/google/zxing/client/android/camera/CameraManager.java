...
public final class CameraManager {
  ...
  private boolean autoFocusRequest;
  
  public CameraManager(Context context,int rotation, boolean autoFocusSetting, boolean flashSetting) {
    this.context = context;
    this.rotation = rotation;
    this.configManager = new CameraConfigurationManager(context,rotation,autoFocusSetting,flashSetting);
    previewCallback = new PreviewCallback(configManager);
    this.autoFocusRequest = autoFocusSetting;
  }
...
//      int height = findDesiredDimensionInRange(screenResolution.y, MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
      ...
      case Surface.ROTATION_0: 
    	  ...
    	  topOffset = (screenResolution.x - height) * 2 / 3; 
    	  framingRect = new Rect(leftOffset, topOffset, screenResolution.y - leftOffset, topOffset + height * 4 / 7);
    	  break;
      default: 
